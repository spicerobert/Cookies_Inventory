...
# 導入功能模組
# from sync_inventory_from_erp import sync_cookie_inventory  # 已停用
...
class CookieInventoryGUI:
    ...
    def _create_widgets(self):
        ...
        self.btn_sync_wip.grid(row=1, column=0, pady=5, sticky="ew")
        ...
        self.btn_sync_production.grid(row=2, column=0, pady=5, sticky="ew")
        ...
        self.btn_sync_receipt.grid(row=3, column=0, pady=5, sticky="ew")
        ...
        self.btn_calculate.grid(row=4, column=0, pady=5, sticky="ew")
        ...
        self.btn_clear.grid(row=5, column=0, pady=5, sticky="ew")
